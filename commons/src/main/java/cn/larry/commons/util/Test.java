...
public class Test {
    ...
    public static void mainw(String[] args) throws Exception {
        BufferedImage image = ImageIO.read(new File("C:\\Users\\larryfu\\Desktop\\test\\404.jpg"));
        ImageIO.write(resizeImage(image, 100, 100), "PNG", new File("C:\\Users\\larryfu\\Desktop\\test\\404_cut.jpg"));
    }
